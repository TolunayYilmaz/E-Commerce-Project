import FeaturedProductCardItems from "../../CardList/featuredProductList/FeaturedProductCardItems.jsx";

export default function FeaturedProductItems({images}) {
  return (
    <section className="flex flex-col gap-20 py-20">
      ...
      <FeaturedProductCardItems images={images} />
    </section>
  );
}
