...
export default function BestProductBotItems({ color, images,cardBg,shadow,count }) {
  return (
    <section className=" bg-[#FAFAFA] pt-10">
      <div className=" flex justify-center flex-col items-center gap-y-10 sm:w-[75vw] sm:mx-auto sm:gap-y-5">
        ...
        <BestProductBotCardItems images={images} cardbg={cardBg} shadow={shadow} count={count} />
      </div>
    </section>
  );
}
