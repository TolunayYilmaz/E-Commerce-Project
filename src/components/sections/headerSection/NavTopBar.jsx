        ...
        <div className="flex justify-around">
          ...
          <div className="flex gap-2">
            <div className="flex gap-2 ">
              ...
              <User
                    className="h-6 text-[#3C403D]  sm:text-[#23A6F0] hover:text-[#23A6F0] "
                ...
                <div className="sm:hidden relative " onMouseLeave={()=>{setLoginDropdown(false)}}>
                  <User
                    className="h-6 text-[#3C403D] sm:text-[#23A6F0] hover:text-[#23A6F0]  hover:cursor-pointer   transform hover:scale-105 transition-all duration-300"
