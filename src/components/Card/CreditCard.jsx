export default function CreditCard({key,item}) {
  return (
  
<div key={key}>
<div className="ml-1 flex gap-1">
<input type="radio" className="bg-red-50"/>
...
<div className=" relative h-[120px] w-[200px] rounded-xl bg-gradient-to-r from-gray-500 to-gray-400 text-white shadow-2xl transition-transform hover:scale-110">
      <div className="absolute top-2 w-full px-3">
        <div className="flex justify-between items-center">
          <div>
            <p className="text-[10px] font-light leading-none">{item.name_on_card}</p>
      ...
      <div className="absolute bottom-2 w-full px-3">
        <div className="text-[9px] font-light leading-tight text-white space-y-[2px]">
          <p>Member Since: {item.expire_month}/{item.expire_year}</p>
          <p>Status: Active</p>
        </div>
      </div>
    </div>
