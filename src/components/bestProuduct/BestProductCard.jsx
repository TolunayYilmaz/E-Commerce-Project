...
export default function BestProductCard({Image}) {
  return (
    <div className="w-[376px] h-[589px]  flex justify-between flex-col items-center sm:w-[188px] lg:w-[188px] 2xl:w-[12.7vw] sm:h-[324px] sm:gap-[10px]">
      <div className=" w-[90%] h-[427px] bg-yellow-500 text-6xl font-bold  sm:text-2xl sm:w-[100%] sm:h-[54%]">
        <img src={Image} className="object-fill h-full w-full"></img>
      </div>
