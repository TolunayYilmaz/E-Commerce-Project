export default function BestProductBotCard({ImagePath}) {
    return (
      <div className="w-[376px] h-[589px]  flex justify-between flex-col items-center  sm:w-[238px] sm:h-[442px] sm:justify-around">
        <div className=" w-[90%] h-[427px] bg-yellow-500 text-6xl font-bold sm:w-[100%] sm:text-2xl sm:h-[280px]">{ImagePath}</div>
